...
class __TwigTemplate_fe87f9d6c88e502d19565ab9377572c5 extends Template
{
    ...
    <div class=\"card-body\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["candidature"]) {
            ...
            yield "\" class=\"btn btn-sm btn-warning\" title=\"Modifier\">
                                ...
                                <form action=\"";
            // line 51
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_candidature_delete", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["candidature"], "id", [], "any", false, false, false, 51)]), "html", null, true);
            yield "\" method=\"post\" style=\"display:inline;\" onsubmit=\"return confirm('Êtes-vous sûr de vouloir supprimer cette candidature ?');\">
...
";
    ...
    {
        return array (  230 => 64,  221 => 60,  219 => 59,  206 => 51,  200 => 48,  194 => 45,  188 => 42,  184 => 41,  181 => 40,  177 => 38,  171 => 36,  169 => 35,  164 => 33,  160 => 32,  157 => 31,  152 => 30,  130 => 11,  124 => 7,  111 => 6,  88 => 4,  65 => 3,  42 => 1,);
    }
                    ...
                    <tr>
                        ...
                        <td class=\"text-center\">
                            <div class=\"btn-group\">
                                ...
                                <form action=\"{{ path('app_candidature_delete', {'id': candidature.id}) }}\" method=\"post\" style=\"display:inline;\" onsubmit=\"return confirm('Êtes-vous sûr de vouloir supprimer cette candidature ?');\">
                                    <button type=\"submit\" class=\"btn btn-sm btn-danger\" title=\"Supprimer\">
                                        <i class=\"fas fa-trash-alt\"></i>
                                    </button>
                                </form>
...
{% endblock %}
", "candidature/index.html.twig", "C:\\ProjetsSymfony\\my-project\\templates\\candidature\\index.html.twig");
    }
}
